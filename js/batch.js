...
export function computeFromParams(params) {
  ...
  const rows = [
    ...
    ['Inductive reactance X<sub>L</sub>',       Xl.toFixed(4),                       'Ω'],
    ['Capacitive reactance X<sub>C</sub>',      Xc.toFixed(4),                       'Ω'],
    ['A',                            fmtComplex(abcd.A),                   ''],
    ['B',                            fmtComplex(abcd.B),                   'Ω'],
    ['C',                            fmtComplex(abcd.C),                   'S'],
    ['D',                            fmtComplex(abcd.D),                   ''],
    ['Sending end voltage (phase)',        fmtComplex(vs.phase),       'kV'],
    ['Sending end voltage (line-to-line)', fmtComplex(vs.linetoline), 'kV'],
    ['Sending end current I<sub>s</sub>',        fmtComplex(is),                      'A'],
    ['Charging current I<sub>c</sub>',           fmtComplex(ich),                     'A'],
    ['Voltage regulation',            vr.toFixed(4),                       '%'],
    ['Power loss (3φ)',                lossMW.toFixed(4),                   'MW'],
    ['Transmission efficiency',       (eta * 100).toFixed(2),              '%'],
    ['Surge impedance Z<sub>c</sub>',            calc.Zc().toFixed(4),                'Ω'],
